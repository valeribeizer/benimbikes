...
const OurServices = () => {
  return (
    <div
      id="services"
      className="container"
      style={{ flexDirection: "column", marginLeft: "0", marginTop: "40px", paddingLeft: "0" }}
    >
      <h2>Our services</h2>
      <div className="ourServicesContainer">
        ...
        <div className="infoOurServices">
          <p>
            ...
            is experienced in locating unique and high-quality bikes that match
            your preferences.
            <br />
            <br />
          ...
          <Accordion>
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
                In addition to our bike scouting services, we also offer
                comprehensive bike repair services. Our skilled technicians are
                equipped to handle all kinds of bike repairs, ensuring that your
                bike is in optimal condition for a smooth and enjoyable ride.
              </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey="3">
              ...
              <Accordion.Body>
                ...
                connections, break down barriers, and promote understanding and
                acceptance.
                <br />
                <br /> We are open to collaborations and partnerships with
                organizations and schools that share our vision. Together, we
                can create programs and events that promote cycling among young
                people and provide them with opportunities to learn, grow, and
                build community. If you are interested in partnering with us or
                have ideas on how we can promote cycling among young people,
